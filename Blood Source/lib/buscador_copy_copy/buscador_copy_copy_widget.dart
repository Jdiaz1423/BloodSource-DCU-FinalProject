...
import 'buscador_copy_copy_model.dart';
export 'buscador_copy_copy_model.dart';

class BuscadorCopyCopyWidget extends StatefulWidget {
  const BuscadorCopyCopyWidget({Key? key}) : super(key: key);

  @override
  _BuscadorCopyCopyWidgetState createState() => _BuscadorCopyCopyWidgetState();
}

class _BuscadorCopyCopyWidgetState extends State<BuscadorCopyCopyWidget> {
  late BuscadorCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BuscadorCopyCopyModel());
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  'Andi Cepeda',
                                  style:
                                      JdiazFlowTheme.of(context).bodyMedium,
                                ),
                              ),
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
