            ...
            if (responsiveVisibility(
              ...
              wrapWithModel(
                ...
                child: SideBarNavWidget(
                  oneBG: JdiazFlowTheme.of(context).secondaryBackground,
                  oneIcon: Icon(
                    Icons.bar_chart_rounded,
                    color: JdiazFlowTheme.of(context).primaryText,
                  ),
                  twoBG: JdiazFlowTheme.of(context).primaryBackground,
                  twoIcon: Icon(
                    ...
                    Align(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: JdiazFlowTheme.of(context).primaryBackground,
                              ...
                              children: [
                                              ...
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 4.0, 0.0, 0.0),
                                                child: Text(
                                                  'Aqui podras encontrar mas personas con tu mismo tipo de sangre..',
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    'Busca tu clase',
                                    style:
                                        JdiazFlowTheme.of(context).titleSmall,
                                  ),
                                ),
                                Container(
                                  width: double.infinity,
                                                              ...
                                                              style: JdiazFlowTheme
                                                                  ...
                                                                  .override(
                                                                    ...
                                                                    useGoogleFonts: GoogleFonts
                                                                            .asMap()
                                                                        .containsKey(
                                                                            JdiazFlowTheme.of(context).titleMediumFamily),
                                                                  ),
                                                            ),
                                                            Text(
                                                              '12 Activos',
                                                                  ...
                                                                  style: JdiazFlowTheme.of(
                                                                      ...
                                                                      .override(
                                                                        ...
                                                                        fontWeight:
                                                                            FontWeight.normal,
                                                                        useGoogleFonts:
                                                                            GoogleFonts.asMap().containsKey(JdiazFlowTheme.of(context).bodyMediumFamily),
                                                                      ),
                                                                ),
                                                              ],
                                                            ),
